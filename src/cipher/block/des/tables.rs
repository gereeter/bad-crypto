...
pub const PERMUTED_CHOICE_1: [[u8; 28]; 2] = [
    [
        57, 49, 41, 33, 25, 17, 9,
        1,  58, 50, 42, 34, 26, 18,
        10, 2,  59, 51, 43, 35, 27,
...
pub const PERMUTED_CHOICE_2: [u8; 48] = [
...
pub const KEY_SCHEDULE_ROTATIONS: [u32; 16] = [
    1, 1, 2, 2,
    2, 2, 2, 2,
    1, 2, 2, 2,
    2, 2, 2, 1
...
mod tests {
    ...
    #[test]
    fn subs_made_up_of_4_perms() {
        for tab in &SUBSTITUTIONS {
            for &outer in &[0b0_0000_0, 0b0_0000_1, 0b1_0000_0, 0b1_0000_1] {
                let mut seen = HashSet::new();
                for inner in 0..16 {
                    let key = tab[outer | inner << 1];
